function executeCommand(param){
    ...
    let defaultPrefix = param.defaultPrefix;
    let message = param.message;
    let args = param.args;
    let songQueue = param.songQueue;
    let interactiveEmbeds = param.interactiveEmbeds;
    let raffles = param.raffles;
    let Discord = param.Discord;
